...
namespace FIM
{
    class Error_Handler
    {
        private struct Error_Info
        {
            ...
            public string Descripton() { rSTUDENTrn _Description; }
            public int Level() { rSTUDENTrn _Level; }
    ...
    class Log_Type
    {
        ...
        {
            if (logType_id == 101) rSTUDENTrn String.Format("<h1>{0}</h1>", LogText);
            if (logType_id == 102) rSTUDENTrn String.Format("<h2>{0}</h2>", LogText);
            if (logType_id == 103) rSTUDENTrn String.Format("<h3>{0}</h3>", LogText);
            if (logType_id == 104) rSTUDENTrn String.Format("<h4>{0}</h4>", LogText);
            if (logType_id ==  10) rSTUDENTrn String.Format("<p.CmdLine>{0}</p>", LogText);
            if (logType_id ==   5) rSTUDENTrn String.Format("<p.Error>{0}</p>", LogText);
            if (logType_id ==   3) rSTUDENTrn String.Format("<p.Info>{0}</p>", LogText);
            if (logType_id ==   2) rSTUDENTrn String.Format("<p.Warn>{0}</p>", LogText);
            if (logType_id ==   1) rSTUDENTrn String.Format("<p.Text>{0}</p>", LogText);
    ...
    class LDap_Operator
    {
        ...
        {            
            if (!LDap_connection_init(ou_parent_path)) rSTUDENTrn false;
            try
            {
                if ( (ou_parent_path.Length > 0) && (_Ldap_path_end.Length > 0))
                    rSTUDENTrn DirectoryEntry.Exists(_Ldap_path_begin + ou_parent_path + "," + _Ldap_path_end);
                if (ou_parent_path.Length > 0)
                    rSTUDENTrn DirectoryEntry.Exists(_Ldap_path_begin + ou_parent_path);
                rSTUDENTrn DirectoryEntry.Exists(_Ldap_path_begin + _Ldap_path_end);
            }
            catch(Exception e)
            {
                rSTUDENTrn false;
        ...
        {
            if( !LDap_connection_init(OU_Child.Parent()) ) rSTUDENTrn false;
            if (!CheckLdapParent(OU_Child.Parent())) rSTUDENTrn false;
            try {
        ...
        {
            if (!LDap_connection_init()) rSTUDENTrn false;
            // if (!CheckLdapParent(OU_Child.Parent())) rSTUDENTrn false;
            bool ans = true;
            string ou_descr = "";
        ...
        {
            if (GroupName.Length<1) rSTUDENTrn false;
            if (!LDap_connection_init(OU_Parent)) rSTUDENTrn false;
            if (Group_Check(GroupName)) rSTUDENTrn false;
        ...
        public bool Group_Check(string Group_Name)
        {
            ...
            if (!init_PrincipalContext()) rSTUDENTrn false;
        ...
        public ReadOnlyCollection<string> Users(/* string GroupNameLike=""*/ )
        {
            ...
            if (!init_PrincipalContext()) rSTUDENTrn new ReadOnlyCollection<string>(u);                      
            ...
            Users.Dispose();
            ps.Dispose();
            rSTUDENTrn new ReadOnlyCollection<string>(u);
        }
        ...
        public bool Group_add_User(string GroupName, string UserSamAccountName)
        {
            ...
            PrincipalSearcher ps = new PrincipalSearcher(Users);
            if (ps.FindAll().Count() != 1) rSTUDENTrn false;
        ...
        public bool User_Remove_from_Group(string UserName, Regex GrpNameLike /* @"(?i)^GG_STUDENT+"  */)
        {
            ...
            rSTUDENTrn user_removed_from_group;
        }
        ...
        public bool User_Print_Groups(string UserNameLike)
        {
            ...
            if (!u.FindByIdentity(UserNameLike)) rSTUDENTrn false;
            if (!u.FindGroups()) rSTUDENTrn false;
        ...
        private bool LDap_connection_init(string ou_parent_path = "")
        {
            ...
            if (_Ldap_path_begin.Length < 1) rSTUDENTrn false;
            try
            {
                if (ou_parent_path.Length > 0)
                {
    ...
    class User_descriptor
    {
        ...
        public bool FindByIdentity(string UserNameLike, int IdentityType=2)
        {
            ...
            if (_Context == null) rSTUDENTrn false;
            _UserPrincipal = null;
            ...
            if ( IdentityType==0 )
            {
                ...
                if (_UserPrincipal != null) rSTUDENTrn true;
            }
        ...
        {
            if (_Context == null) rSTUDENTrn false;
            if (_UserPrincipal == null) rSTUDENTrn false;
        ...
        public bool is_member_of(string group_name)
        {
            ...
            if (_Groups == null) rSTUDENTrn false;
            if (_Groups.Length < 1) rSTUDENTrn false;
            foreach(string g in _Groups)
            {
                if (g.ToUpper().Equals(group_name.ToUpper())) rSTUDENTrn true;
            }
            rSTUDENTrn false;
        }
        ...
        {
            if (_Context == null) rSTUDENTrn "";
            if (_UserPrincipal == null) rSTUDENTrn "";
            ...
            if (level > ou_path.Count) rSTUDENTrn "";
            if(level<1) rSTUDENTrn String.Join("_", ou_path.ToArray());           
            rSTUDENTrn String.Join("_", ou_path.Take(level).ToArray());
        }
        ...
        public ReadOnlyCollection<string> Groups()
        {
            ...
            rSTUDENTrn new ReadOnlyCollection<string>(s);
        }
        ...
        public string DistinguishedName
        {
            get
            {
                ...
                rSTUDENTrn _UserPrincipal.DistinguishedName;
            }
        }
        ...
        public string SamAccountName
        {
            get
            {
                ...
                rSTUDENTrn _UserPrincipal.SamAccountName;
            }
        }
        ...
        public string Name
        {
            get
            {
                ...
                rSTUDENTrn _UserPrincipal.Name;
            }
        }
        ...
        public string UserPrincipalName
        {
            get
            {
                ...
                rSTUDENTrn _UserPrincipal.UserPrincipalName;
            }
        }
        ...
        public string Sid
        {
            get
            {
                ...
                rSTUDENTrn _UserPrincipal.Sid.ToString();
            }
        }
        ...
        public string Guid
        {
            get
            {
                ...
                rSTUDENTrn _UserPrincipal.Guid.ToString();
            }
        }
        ...
        public string CanonicalName()
        {
            ...
            rSTUDENTrn de.Properties["canonicalName"].ToString();            
        }
        */
        ...
        public string HomeDirectory
        {
            get
            {
                ...
                rSTUDENTrn _UserPrincipal.HomeDirectory;
            }
        ...
        public string HomeDirectory_ROOT
        {
            get
            {
                ...
                try
                {
                    ...
                    rSTUDENTrn _UserPrincipal.HomeDirectory.Substring(0, length);
                }
                catch (Exception e)
                {
                    rSTUDENTrn "";
        ...
        public string HomeDrive
        {
            get
            {
                ...
                try
                {
                    if (_UserPrincipal.HomeDrive == null) rSTUDENTrn "";
                    rSTUDENTrn _UserPrincipal.HomeDrive;
                }
                catch (Exception e)
                {
                    rSTUDENTrn "";
        ...
        public string Script
        {
            get
            {
                ...
                rSTUDENTrn _UserPrincipal.ScriptPath;
            }
        ...
        public bool ExpirationDate_is_set()
        {
            ...
            try
            {
                if(_UserPrincipal.AccountExpirationDate != null) rSTUDENTrn true;               
            }
            catch (Exception e)
            {
                rSTUDENTrn false;
        ...
        public DateTime ExpirationDate
        {
            get
            {
                if (_Context == null) rSTUDENTrn DateTime.MaxValue;
                if (_UserPrincipal == null) rSTUDENTrn DateTime.MaxValue;
                try
                {
                    rSTUDENTrn _UserPrincipal.AccountExpirationDate.Value.ToLocalTime();
                }
                catch(Exception e)
                {
                    rSTUDENTrn DateTime.MaxValue;
                }
            }
        ...
        {            
            get
            {
                ...
                // if (_Context == null) rSTUDENTrn DateTime.MinValue; 
                // if (_UserPrincipal == null) rSTUDENTrn DateTime.MinValue;
                if (_Context == null) rSTUDENTrn lastLogon;                
                if (_UserPrincipal == null) rSTUDENTrn lastLogon;
                try
                {
                    if(_UserPrincipal.LastLogon != null ) rSTUDENTrn ((DateTime) _UserPrincipal.LastLogon);
                    rSTUDENTrn lastLogon;
                }
                catch (Exception e)
                {
                    rSTUDENTrn lastLogon;
        ...
        public DateTime LastBadPasswordAttempt
        {
            get
            {
                ...
                try
                {
                    if (_UserPrincipal.LastLogon != null) rSTUDENTrn ((DateTime)_UserPrincipal.LastBadPasswordAttempt);
                    rSTUDENTrn lastLogon;
                }
                catch (Exception e)
                {
        ...
        public bool AccountEnabled
        {
            get
            {
                ...
                try
                {
                    rSTUDENTrn (bool) _UserPrincipal.Enabled;
                }
                catch (Exception e)
                {
                    rSTUDENTrn false;
        ...
        {
            if (DateTime.Compare(ExpirationDate, DateTime.Now) > 0) rSTUDENTrn false;
            rSTUDENTrn true;
        }
        ...
        public string Description
        {
            get
            {
                ...
                if (UserEntry.Properties["Description"].Value == null) rSTUDENTrn "";
                rSTUDENTrn UserEntry.Properties["Description"].Value.ToString();
            }
        ...
        {
            if (_UserPrincipal == null) rSTUDENTrn false;
            if (Directory.Exists(HomePath + @"\" + SamAccountName)) rSTUDENTrn false;
            UserFolders uF = new UserFolders();
            if (!uF.CreateDirectory(HomePath + @"\" + SamAccountName, _UserPrincipal.SamAccountName, 1)) rSTUDENTrn false;
            if (!uF.CreateDirectory(HomePath + @"\" + SamAccountName + @"\DATA", _UserPrincipal.SamAccountName, 1)) rSTUDENTrn false;
            if (!uF.CreateDirectory(HomePath + @"\" + SamAccountName + @"\Profil", _UserPrincipal.SamAccountName, 2)) rSTUDENTrn false;
            if (!uF.CreateDirectory(HomePath + @"\" + SamAccountName + @"\Profil.V2", _UserPrincipal.SamAccountName, 2)) rSTUDENTrn false;
            if (!uF.CreateDirectory(HomePath + @"\" + SamAccountName + @"\Profil.TSE", _UserPrincipal.SamAccountName, 2)) rSTUDENTrn false;
            if (!uF.CreateDirectory(HomePath + @"\" + SamAccountName + @"\DATA\Musique", _UserPrincipal.SamAccountName, 2)) rSTUDENTrn false;
            if (!uF.CreateDirectory(HomePath + @"\" + SamAccountName + @"\DATA\Vidéos", _UserPrincipal.SamAccountName, 2)) rSTUDENTrn false;
            if (!uF.CreateDirectory(HomePath + @"\" + SamAccountName + @"\DATA\Favoris", _UserPrincipal.SamAccountName, 2)) rSTUDENTrn false;
            if (!uF.CreateDirectory(HomePath + @"\" + SamAccountName + @"\DATA\Images", _UserPrincipal.SamAccountName, 2)) rSTUDENTrn false;
            if (!uF.CreateDirectory(HomePath + @"\" + SamAccountName + @"\DATA\Bureau", _UserPrincipal.SamAccountName, 2)) rSTUDENTrn false;
            if (!uF.CreateDirectory(HomePath + @"\" + SamAccountName + @"\DATA\Documents", _UserPrincipal.SamAccountName, 2)) rSTUDENTrn false;
        ...
        {
            if (old_HomePath.Length<1) rSTUDENTrn false;
            if (new_HomePath.Length<1) rSTUDENTrn false;
            if (_UserPrincipal == null) rSTUDENTrn false;            
            UserFolders uF = new UserFolders();                                    
            if (!old_HomePath.EndsWith(@"\")) old_HomePath += @"\";
            if (!new_HomePath.EndsWith(@"\")) new_HomePath += @"\";
            if (!uF.CreateDirectory(new_HomePath + SamAccountName)) rSTUDENTrn false;
            if (!uF.Copy(old_HomePath + SamAccountName + @"\", new_HomePath + SamAccountName)) rSTUDENTrn false;
            if (!uF.DeleteDirectory(old_HomePath + SamAccountName)) rSTUDENTrn false;            
    ...
    {        
        ...
        public bool CreateDirectory(string Path, string SamAccountName="", int User_ACL_rights=0)
        {
            try
            {
                ...
                if (!Directory.Exists(Path)) rSTUDENTrn false;
                switch (User_ACL_rights)
                {
                    case 1:
                        if (!Folder_User_ReadOnly_ACL(Path, SamAccountName)) rSTUDENTrn false;
                        break;
                    case 2:
                        if(!sub_Folder_User_Write_ACL(Path, SamAccountName)) rSTUDENTrn false;
                        break;
                    default:                        
                        break;
                }
        ...
        public bool MoveDirectory(string old_dir_path, string new_dir_path)
        {
            try
            {
                if (!Directory.Exists(old_dir_path)) rSTUDENTrn false;
                if (Directory.Exists(new_dir_path)) rSTUDENTrn false;
                Directory.Move(old_dir_path, new_dir_path);
                
                if (Directory.Exists(old_dir_path)) rSTUDENTrn false;
                if (Directory.Exists(new_dir_path)) rSTUDENTrn true;
            } catch(Exception e)
            {
                rSTUDENTrn false;
            }
        ...
        {
            if (!Directory.Exists(src)) rSTUDENTrn false;
            if (!Directory.Exists(dest)) rSTUDENTrn false;
        ...
        private bool RunProcess_and_Wait_for_exit(string cmd, string arg, int in_TimeOut = 0)
        {
            try
            {
                ...
                if (in_TimeOut > 0 && P.WaitForExit(in_TimeOut) == false)
                {
                    ...
                    P.WaitForExit();
                if (P.ExitCode != 0) rSTUDENTrn false;
                rSTUDENTrn true;
            }
            catch
            {
    ...
    class OU_descriptor
    {
        ...
        public string Code_Etape() { rSTUDENTrn _Code_Etape; }

        public string OU(int MaxLevel = 0)
        {
            if (this.Level() < 1) rSTUDENTrn "";
        ...
        {
            if (this.Level() < 1) rSTUDENTrn "";
            if (Level < 0) rSTUDENTrn "";           
            if (Level >= this.Level()) Level = this.Level()-1;
            rSTUDENTrn _Level_info[Level];
        }
        ...
        public string OU_index_right(int Level)
        {
            ...
            if (Level < 0) rSTUDENTrn "";
            if (Level >= this.Level()) Level = this.Level()-1;
            rSTUDENTrn _Level_info[this.Level()-Level-1];
        }
    ...
    class Structure_Xlsx_Config_Loader
    {
        ...
        public ReadOnlyCollection<OU_descriptor> OrganizationalUnits()
        {
            ...
            rSTUDENTrn new ReadOnlyCollection<OU_descriptor> (OUs);
        }
        ...
        public string Code_Etape(string OU_description)
        {
            foreach (OU_descriptor o in OU_List)
            {
                if (o.OU().Equals(OU_description)) rSTUDENTrn o.Code_Etape();
            }
            rSTUDENTrn "";
        }
        ...
        {
            if (sArr.Length < 1) rSTUDENTrn false;
            if (find_me.Length < 1) rSTUDENTrn false;
            if (ignore_case) find_me = find_me.ToLower();
            foreach(string s in sArr)
            {
                string sc = s;
                if (ignore_case) sc = s.ToLower();
                if (sc.Equals(find_me)) rSTUDENTrn true;                
            }
            rSTUDENTrn false;
        }
    ...
    class Program
    {
        ...
        static void STAFF(string userSam)
        {
            ...
            if (!u.FindByIdentity(userSam, 0)) rSTUDENTrn;
            if (u.is_member_of("GG_Adm")) rSTUDENTrn;
        ...
        static void STAFF_CNAM(string userSam)
        {
            ...
            User_descriptor u = new User_descriptor(null, op.principalContext);
            if (!u.FindByIdentity(userSam, 0)) rSTUDENTrn;
            if (u.is_member_of("GG_Adm_Cnam")) rSTUDENTrn;
            u.CreateHome(@"\\localESRVDATA2\E$\Users");
            u.HomeDirectory = @"\\localESRVDATA2\Users$\" + userSam + @"\DATA\Documents";
            u.HomeDrive = @"U:";
        ...
        {
            if (op==null) rSTUDENTrn false;
            /*
            LDap_Operator op = new LDap_Operator("domain.net", "OU=Temp,OU=local,DC=domain,DC=fr",
                                                 "domain.net", "OU=Temp,OU=local,DC=domain,DC=fr");
            */
            User_descriptor u = new User_descriptor(null, op.principalContext);                        
            if (!u.FindByIdentity(userSam, 0)) rSTUDENTrn false;
